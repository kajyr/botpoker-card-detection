...
test('Test coppia', function (t) {
	...
	t.notOk(detector.hasCoppia(table), 'Non viene trovata la coppia quando non c\'è')
...
test('Test doppia coppia', function (t) {
	...
	t.ok(detector.hasDoppiaCoppia(cards), 'Viene trovato il doppia coppia')
	t.notOk(detector.hasDoppiaCoppia(table), 'Non viene trovato il doppia coppia quando non c\'è')
